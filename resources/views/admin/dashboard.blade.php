		...
		<section class="content">
			<div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            <span class="info-box-icon"><i class="fa fa-star-half-full"></i></span>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-info">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ number_format($sales->sum('total'),2) }} </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($today->sum('pay'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($month->sum('pay'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($year->sum('pay'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-success">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ number_format($sales->sum('pay'),2) }} </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($today->sum('due'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($month->sum('due'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($year->sum('due'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ number_format($sales->sum('due'),2) }} </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($today_expenses->sum('amount'),2) }} </span>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($month_expenses->sum('amount'),2) }} </span>
                                @php
                                    if($yesterday_expenses->sum('amount') != 0)
                                    {
                                        $percentage = (($today_expenses->sum('amount') - $yesterday_expenses->sum('amount'))/ $yesterday_expenses->sum('amount'))*100;
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($year_expenses->sum('amount'),2) }} </span>
                                @php
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number mb-3">{{ number_format($expenses->sum('amount'),2) }} </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
