...
@section('title', 'Monthly Detailed Purchases')
@section('maintitle', 'Monthly Purchases')
@section('mainUrl', route('admin.receiving.monthly'))
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header row">
                                <div class="col-sm-6 ">
                                  <h3 class="card-title">
                                      <strong class="text-danger show-month">{{strtoupper(date('F', strtotime(substr($today,6,9)."-".substr($today,0,2)."-".substr($today,3,5) ))) }} {{substr($today,6,9)}}</strong> SALES LISTS
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatablemonthdetailed")}}',
                ...
                columns: [
                    {data: 'purchase_id', width:"7%" , className :"text-left"},
                    {data: 'supplier', width:"15%", className :"text-left"},
                    {data: 'invoiceno', width:"10%", className :"text-left"},
                    {data: 'purchase_date', width:"8%", className :"text-left"},
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/receiving/month/detailed/'}}"+$("#dateto").val())
            });
        ...
        function ajaxReload(month){
          ...
          // alert(months[parseInt(month)-1])
          $(".show-month").html(months[parseInt(month)-1]+" "+ $("#yearto").val());
          $("#datefrom").val(month+'-01-'+$("#yearto").val())
          $("#dateto").val(month+'-28-'+$("#yearto").val())
            // alert($("#dateto").val())
          reloadDatatable();
        }
