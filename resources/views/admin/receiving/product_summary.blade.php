...
@section('title', 'Purchases Summary By Product')
@section('maintitle', 'Purchases Summary')
@section('mainUrl',route("admin.receiving.summary.supplier") )
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <?php
            $getYir = "Product Purchases Summary Report";
                            ...
                            <div class="card-header row">
                                ...
                                <div class="col-sm-4 ">
                                  <a href="#" id = "repDetailed" class="btn btn-primary float-right btn-sm">
                                    <i class="fa fa-list-alt nav-icon"></i> Quantity Summary
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var strDate =  (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getFullYear();
             table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatableproduct")}}',
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/receiving-summary/product/qty'}}")
            });
