...
@section('title', 'Today\'s Purchases - Detailed')
@section('maintitle', 'Today\'s Purchases')
@section('mainUrl', route('admin.receiving.today'))
                    ...
                    <div class="col-md-12">
                      <div class="card">
                          <div class="card-header">
                                ...
                                <div class="col-sm-6 ">
                                  <h5>Daily Purchases Report (<span class="text-dark  today-span">{{ $today }}</span>)</h5>
                                </div>
                                <div class="col-sm-6 ">
...
<!--
    ...
    <script>
      ...
      $(document).ready(function(){
          // alert({{$today}})
          // urlAjax = "{{url('/') . '/admin/receiving/todaydetailed/'.$today}}";
          var d = new Date();
          ...
          var table = $('#example1').DataTable({
              ...
              buttons: [
                ...
                },
                {
                    ...
                    message: function() { return 'Daily Purchases Report : '+ $("#dateto").val() }
                },
                {
                ...
                },
                {
                    ...
                    autoPrint: true,
                    message: function() { return '<h4>Daily Purchases Report : '+  $("#dateto").val() + "</h4>" }
                }
              ],
              pageLength: 100,
              method: "post",
