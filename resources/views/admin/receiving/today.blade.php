...
@section('title', 'Today\'s Purchases')
                    ...
                    <div class="col-md-12">
                      <div class="card">
                          <div class="card-header">
                                ...
                                <div class="col-sm-6 ">
                                  <h5>Daily Purchases Report (<span class="text-dark  today-span">{{ date('Y-m-d') }}</span>)</h5>
                                </div>
                                <div class="col-sm-6 ">
    ...
    <script>
      ...
      $(document).ready(function(){
          ...
          $("#repDetailed").click(function(){
            $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/receiving/todaydetailed/'}}"+$("#dateto").val())
          });
      });
