...
@section('title', 'Yearly Detailed Purchases')
@section('maintitle', 'Yearly Total Purchases')
@section('mainUrl', route('admin.receiving.total'))
        ...
        $(document).ready(function(){
            ...
            table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatableyeardetailed")}}',
                    //
                    //
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/sales-total/detailed/'}}"+$("#dateto").val())
            });
