...
@section('title', 'Purchases Summary By Supplier')
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <?php
            $getYir = "Supplier Purchases Summary Report";
                            ...
                            <div class="card-header row">
                                ...
                                <div class="col-sm-4 ">
                                  <a href="#" id = "repDetailed" class="btn btn-primary float-right btn-sm">
                                    <i class="fa fa-list-alt nav-icon"></i> Product Summary
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var strDate =  (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getFullYear();
             table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatablesupplier")}}',
                ...
                columns: [
                    {data: 'supplier_id', width:"10%" , className :"text-left"},
                    {data: 'supplier', width:"22%", className :"text-left"},
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/receiving-summary/product/'}}" )
            });
