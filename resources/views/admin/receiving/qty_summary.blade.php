...
@section('title', 'Purchases Summary By Quantity')
@section('maintitle', 'Product Purchases Summary ')
@section('mainUrl',route("admin.receiving.summary.product") )
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <?php
            $getYir = "Product Quantity Purchases Summary Report";
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/receiving-summary/product/'}}"+$("#dateto").val())
            });
