...
@section('maintitle', 'Payment Purchase')
                      ...
                      <div class="col-md-12">
                          ...
                          <div class="card card-primary">
                              <div class="card-header">
                                  <h3 class="card-title">Create Payment Purchase</h3>
                              </div>
                              <!-- /.card-header -->
                              ...
                              <!-- form start -->
                                        ...
                                        <br>  <br>
                                          <div class="row">
                                                ...
                                                <div class="form-group  col-md-12">
                                                    ...
                                                    <select required id="supplier_id" name="supplier_id" class="selectpicker ajax-supplier w-100" data-live-search="true"></select>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-12">
                                              <div class="form-group">
                                                  <label>Date</label>
                                                  <input required type="date" class="form-control  " name="payment_date" value="{{ date('Y-m-d') }}" placeholder="Date of Payment">
                                              </div>
                                            </div>
                                  ...
                                  <div class="card-footer">
                                      <button type="submit" class="btn btn-primary float-md-right">Save Supplier Payment</button>
                                  </div>
                                  <!-- <div class="card-footer">
...
<script type="text/javascript" src="https://www.jqueryscript.net/demo/AJAX-Autocomplete-Bootstrap-Select/dist/js/ajax-bootstrap-select.js"></script> -->
  ...
  <script>
      ...
      $('#variant_id').change(function(){
          ...
          $('#payment_price').val($(this).find(':selected').data('price'));
          getTotal();
      });
      $('#qty').change(function(){
          getTotal();
      ...
      function getTotal(){
        ...
        var price = parseFloat($('#payment_price').val());
        if (price > 0){
        }else { price = 0}
