                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List of Receipts

                                <?php
                                  $addBtn = route('admin.receipt.create');
                                  $BtnCaption = "New Receipt ";
                                ?>
                        ...
                        <div class="modal-content">
                            <div class="modal-header bg-dark">
                                <h5 class="modal-title" id="modalPaymentLabel">
                                    Payment Receipt Header [Updating]
                                </h5>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                              ...
                                              <div class="form-group  col-md-12">
                                                  ...
                                                  <input required type="hidden" class="form-control " name="receipt_id"  id="receipt_id" value=" " placeholder="Customer">
                                                  <input required type="hidden" class="form-control " name="customer_id" id="customer_id" value=" " placeholder="Customer">
                                                  <input required readonly type="text" class="form-control " name="name" id="name" value=" " placeholder="Customer">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input required type="date" class="form-control  " name="receipt_date" id="receipt_date" value="" placeholder="Date of Receipt">
                                            </div>
                                          </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            var table = $('#table1').DataTable({
                ...
                ajax: {
                    'url' : '{{ route("admin.receipt.datatable")}}',
                    //
                    //
                    // success: function(data) {
                    //   // swal( JSON.stringify(data));
                    //      alert( JSON.stringify(data));
                    //   //var mdata = '{"draw":1,"recordsTotal":1,"recordsFiltered":1,"data":[{"id":1,"name":"Product 1","category_id":1,"customer_id":1,"code":"1232141","garage":"A","route":"A","image":"1232141.png","buying_date":"2022-01-01 00:00:00","expire_date":"2222-09-12 00:00:00","buying_price":1000,"selling_price":1500,"created_at":"2022-06-02 17:03:19","updated_at":"2022-06-02 20:58:54","category":"category 1","customer":"Supplier 1"}]}';
                    //   //return mdata;
                ...
                columns: [
                    ...
                    {data: 'customer', width:"35.2%", className :"text-left"},
                    {data: 'orno', width:"14%", className :"text-left"},
                    {data: 'receipt_date', width:"10%", className :"text-left"},
                    {data: 'total', width:"10%", className :"text-right"},
                    {data: 'actions', width:"100%", className :"text-leftL actionsCol"},
                    {data: 'customer_id', width:"1px", className :"d-none"},
        ...
        function showEditForm(e){
           ...
           $("#formPayment").attr('action',"{{ route('admin.receipt.update') }}");

           $("#receipt_id").val(e);

           customer_id = $("#table1 #row_"+e+" td:nth-child(7)").text();
           name = $("#table1 #row_"+e+" td:nth-child(2)").text();
           orno = $("#table1 #row_"+e+" td:nth-child(3)").text();
           receipt_date = $("#table1 #row_"+e+" td:nth-child(4)").text();
