...
@section('maintitle', 'Supplier')
@section('mainUrl',route("admin.supplier.index") )
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                      ...
                                                      <label id="labelInputFile" class="custom-file-label" for="exampleInputFile">{{ $supplier->image }}</label>
                                                    </div>
                                                </div>
                                                <p class="mt-2">
                                                    <img id="supplier-img"  width="50" height="50" src="{{ URL::asset("supplier/".$supplier->photo) }}" alt="{{ $supplier->name }}">
                                                </p>
  ...
  function readURL(input) {
      if (input.files && input.files[0]) {
          ...
          reader.onload = function (e) {
              $('#supplier-img').attr('src', e.target.result);
          }
