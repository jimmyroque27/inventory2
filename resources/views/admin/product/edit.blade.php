                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file col-sm-8">
                                                        ...
                                                        <label id="labelInputFile" class="custom-file-label" for="exampleInputFile">{{ $product->image }}</label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                      <img   class="  table-bordered" style="padding:10px" id="prod-img" width="100px" height="100px" src="{{URL::asset('product/'  .$product->image) }}" alt="{{ $product->name }}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="buying_date" value="{{ date_format($product->buying_date,'Y-m-d') }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Expire Date</label>
                                                <input type="date" class="form-control" name="expire_date" value="{{ date_format($product->expire_date,'Y-m-d') }}">
                                            </div>
                                            <div class="form-group">
