...
@section('title', 'Sales Summary By Product')
@section('maintitle', 'Sales Summary')
@section('mainUrl',route("admin.sales.summary.customer") )
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <?php
            $getYir = "Product Sales Summary Report";
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/sales-summary/product/qty'}}")
            });
