...
@section('title', 'Monthly Detailed Sales')
@section('maintitle', 'Monthly Sales')
@section('mainUrl', route('admin.sales.monthly'))
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/sales/month/detailed/'}}"+$("#dateto").val())
            });
