...
@section('title', 'Sales Summary By Customer')
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <?php
            $getYir = "Customer Sales Summary Report";
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var strDate =  (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getFullYear();
             table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatablecustomer")}}',
                ...
                columns: [
                    {data: 'customer_id', width:"10%" , className :"text-left"},
                    {data: 'customer', width:"22%", className :"text-left"},
            ...
            $("#repDetailed").click(function(){
              $("#repDetailed").attr("href", urlAjax = "{{url('/') . '/admin/sales-summary/product/'}}" )
            });
