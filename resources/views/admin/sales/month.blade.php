                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header row">
                                <div class="col-sm-6 ">
                                  <h3 class="card-title">
                                      <strong class="text-danger show-month">{{ strtoupper(date('F')) }} {{date('Y')}}</strong> SALES LISTS
            ...
            var strDate =  (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getFullYear();
             table = $('#example1').DataTable({
                ...
                ajax: {
                    ...
                    'url' : '{{ route("admin.order.datatablemonth")}}',
                ...
                columns: [
                    ...
                    {data: 'order_date', width:"10%", className :"text-left"},

                    {data: 'order_status', width:"10%", className :"text-left"},
