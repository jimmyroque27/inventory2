...
class Cart
{
    ...
    public function updateQtyDiscount($rowId, $qty, $discount)
    {
        $cartItem = $this->get($rowId);
        ...
        // if ($discount instanceof Buyable) {
        //     $cartItem->updateFromBuyable($discount);
        // } elseif (is_array($discount)) {
        //     $cartItem->updateFromArray($discount);
        // } else {
        ...
        if ($rowId !== $cartItem->rowId) {
            ...
            if ($content->has($cartItem->rowId)) {
                $existingCartItem = $this->get($cartItem->rowId);
                $cartItem->setQtyDiscount($existingCartItem->qty + $cartItem->qty, $existingCartItem->discount + $cartItem->discount);
